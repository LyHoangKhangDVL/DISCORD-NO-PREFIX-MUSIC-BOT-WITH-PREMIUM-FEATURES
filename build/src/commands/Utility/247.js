                ...
                return message.reply({
                    embeds: [
                        this.client.utils
                            ...
                            .setDescription(`❌ You need **Manage Guild** permissions to use this command`)
                            .setTimestamp(),
                    ],
                });
                ...
                if (data === true) {
                    ...
                    return message.reply({
                        embeds: [
                            this.client.utils
                                .premiumEmbed(message.guild.id)
                                .setDescription(`❌ Successfully **Disabled 24/7 Mode** of ${this.client.user.username} I will not stay in the Voice Channel`)
                                .setTimestamp(),
                        ],
                    });
                }
                    ...
                    return message.reply({
                        embeds: [
                            this.client.utils
                                .premiumEmbed(message.guild.id)
                                .setDescription(`✅ Successfully **Enabled 24/7 Mode** of ${this.client.user.username} Now I will Stay in the Voice Channel`)
                                .setTimestamp(),
                        ],
                    });
                }
                ...
                if (data === true)
                    return message.reply({
                        embeds: [
                            this.client.utils
                                .premiumEmbed(message.guild.id)
                                .setDescription(`❗ **24/7 Mode** of ${this.client.user.username} is Already **Enabled**`)
                        ],
                    });
                else {
                ...
                if (data === false)
                    return message.reply({
                        embeds: [
                            this.client.utils
                                .premiumEmbed(message.guild.id)
                                .setDescription(`❗ **24/7 Mode** of ${this.client.user.username} is Already **Disabled**`)
                        ],
                    });
                else {
                    ...
                    return message.reply({
                        embeds: [
                            this.client.utils
                                .premiumEmbed(message.guild.id)
                                .setDescription(`✅ Successfully **Disabled 24/7 Mode** of ${this.client.user.username} Now I will not Stay in the Voice Channel`)
                                .setTimestamp(),
                        ],
                    });
                }
