        ...
        return message.reply({
          embeds: [
            this.client.utils
              ...
              .setDescription(
                `❌ You need **Manage Guild** permissions to use this command`,
              )
        ...
        if (!hex)
          return message.reply({
            embeds: [
              this.client.utils
                .premiumEmbed(message.guildId)
                .setDescription(`❌ Please provide me a hex color`),
            ],
          });
        hex = checkHex(args[1]);
        if (hex === false)
          return message.reply({
            embeds: [
              this.client.utils
                .premiumEmbed(message.guildId)
                .setDescription(`❌ Please provide me a valid hex color code!`),
            ],
          });
        if (get.HEXCODE === null) {
          ...
          return message.reply({
            embeds: [
              this.client.utils
                .premiumEmbed(message.guildId)
                .setDescription(
                  `✅ Successfully **Updated** Embeds Color to \`${args[1]}\``,
                ),
            ],
          });
        } else {
          ...
          let collector = await msg.createMessageComponentCollector({
            filter: (i) => {
              if (i.user.id === message.author.id) return true;
                ...
                return i.reply({
                  content: `❌ Sorry you are not welcomed using this interaction!`,
                  ephemeral: true,
                });
            },
            time: 100000 * 2,
            ...
            if (interaction.customId === `yes`) {
              ...
              return interaction.update({
                embeds: [
                  this.client.utils
                    .premiumEmbed()
                    .setDescription(
                      `✅ Successfully Set the custom embed color to: \`${args[1]}\`.`,
                    ),
                ],
                components: [],
              });
              ...
              return interaction.update({
                embeds: [
                  this.client.utils
                    .premiumEmbed()
                    .setDescription(`❌ Cancelled the Interaction`),
                ],
                components: [],
              });
            }
            ...
            return message.reply({
              embeds: [
                this.client.utils
                  .premiumEmbed(message.guildId)
                  .setDescription(
                    `❌ Please provide me a valid channel to be created setup on!`,
                  ),
              ],
            });
          if (
            ...
            return message.reply({
              embeds: [
                this.client.utils
                  .errorEmbed()
                  .setDescription(
                    `❌ I don't have **View Channel** permissions in that channel!`,
                  )
            ...
            return message.reply({
              embeds: [
                this.client.utils
                  .errorEmbed()
                  .setDescription(
                    `❌ I don't have **Send Messages** permissions in that channel!`,
                  )
                  .setTitle(`Missing Permissions`),
              ],
            });
            ...
            return message.reply({
              embeds: [
                this.client.utils
                  .errorEmbed()
                  .setDescription(
                    `❌ I don't have **Read Message History** permissions in that channel!`,
                  )
                  .setTitle(`Missing Permissions`),
              ],
            });
            ...
            return message.reply({
              embeds: [
                this.client.utils
                  .errorEmbed()
                  .setDescription(
                    `❌ I don't have **Use External Emojis** permissions in that channel!`,
                  )
                  .setTitle(`Missing Permissions`),
              ],
            });
            ...
            return message.reply({
              embeds: [
                this.client.utils
                  .errorEmbed()
                  .setDescription(
                    `❌ I don't have **Embed Links** permissions in that channel!`,
                  )
                  .setTitle(`Missing Permissions`),
              ],
            });
            ...
            return message.reply({
              embeds: [
                this.client.utils
                  .errorEmbed()
                  .setDescription(
                    `❌ I don't have **Manage Channels** permissions in that channel!`,
                  )
                  .setTitle(`Missing Permissions`),
              ],
            });
            ...
            return message.reply({
              embeds: [
                this.client.utils
                  .errorEmbed()
                  .setDescription(
                    `❌ I don't have **Manage Messages** permissions in that channel!`,
                  )
                  .setTitle(`Missing Permissions`),
              ],
            });
          channel.send(
            `https://cdn.discordapp.com/attachments/1162795987014787162/1205424655679234088/gg.png?ex=65d85231&is=65c5dd31&hm=9746958b5c53418205d11bc9170b0c32b911e484bef10e2b3e26d530b37efd84&`,
          );
          ...
          return message.reply({
            embeds: [
              this.client.utils
                ...
                .setDescription(
                  `✅ Successfully **Created** Music Setup at ${channel}. Hope you enjoy me there`,
                ),
            ],
          });
        }
            ...
            return message.reply({
              embeds: [
                this.client.utils
                  .errorEmbed()
                  .setDescription(
                    `❌ There is no setup for this guild right now!`,
                  ),
              ],
            });
          ...
          return message.reply({
            embeds: [
              this.client.utils
                ...
                .setTitle(`Deleted`)
                .setDescription(
                  `✅ Successfully **Deleted** Server Music Setup`,
                ),
            ],
          });
        }
            ...
            if (!msg) {
              ...
              return message.reply({
                embeds: [
                  this.client.utils
                    .premiumEmbed(message.guildId)
                    .setDescription(`✅ Successfully **Fixed** the Music Setup`)
              ...
              return message.reply({
                embeds: [
                  this.client.utils
                    .errorEmbed()
                    .setDescription(`❌ Setup seems to be fine`),
                ],
              });
          } else {
            this.client.utils.deleteDj(message.guildId);
            return message.reply({
              embeds: [
                this.client.utils
                  .premiumEmbed(message.guildId)
                  .setDescription(
                    `✅ Successfully **Fixed** the Music Setup. Create a new one using \`setup dj create\``,
                  )
                  .setTitle(`Setup Fixed`)
                  .setTimestamp(),
              ],
          ...
          if (this.client.utils.checkDjSetup(message.guildId) === false)
            return message.reply({
              embeds: [
                this.client.utils
                  .errorEmbed()
                  .setDescription(`❌ There is no setup for this guild yet!`),
              ],
            });
          ...
          if (!role)
            return message.reply({
              embeds: [
                this.client.utils
                  .errorEmbed()
                  .setDescription(`❌ Please provide me a valid role`),
              ],
            });
            ...
            return message.reply({
              embeds: [
                this.client.utils
                  .premiumEmbed(message.guild.id)
                  .setDescription(
                    `✅ Successfully **Updated** Djrole to ${role}`,
                  )
            ...
            let collector = await msg.createMessageComponentCollector({
              filter: (b) => {
                if (b.user.id === message.author.id) return true;
                  ...
                  return b.reply({
                    content: `❌ You are not the command requester`,
                    ephemeral: true,
                  });
              },
              time: 100000 * 7,
            ...
            return message.reply({
              embeds: [
                this.client.utils
                  .premiumEmbed(message.guildId)
                  .setDescription(
                    `❌ There is no djrole setupped for this guild`,
                  ),
              ],
            });
          else {
            ...
            return message.reply({
              embeds: [
                this.client.utils
                  .premiumEmbed(message.guild.id)
                  .setDescription(
                    `✅ Successfully **Deleted** Dj role for the server`,
                  ),
              ],
            });
          }
              ...
              return interaction.update({
                embeds: [
                  this.client.utils
                    ...
                    .setDescription(
                      `✅ Successfully **Updated** Play style to: \`Buttons\``,
                    ),
                ],
                components: [],
              });
              ...
              return interaction.update({
                embeds: [
                  this.client.utils
                    ...
                    .setTitle(`Updated Play Style`)
                    .setDescription(
                      `✅ Play style has been **Updated** to: \`Direct\``,
                    ),
                ],
                components: [],
              });
