        ...
        this.exec = async (message, args, prefix) => {
                ...
                return message.reply({
                    embeds: [
                        this.client.utils
                            ...
                            .setDescription(`❌ You require **Manage Guild** permissions to use this command`)
                            .setTimestamp(),
                    ],
                });
            if (args[1])
                return message.reply({
                    embeds: [
                        this.client.utils
                            ...
                            .setDescription(`❌ **No whitespaces** are required in a prefix!`),
                    ],
                });
            if (args[0].length > 3)
                return message.reply({
                    embeds: [
                        this.client.utils
                            .premiumEmbed(message.guild.id)
                            .setDescription(`❌ Prefix's length must not be Greater than 3`),
                    ],
                });
            ...
            return message.reply({
                embeds: [
                    this.client.utils
                        .premiumEmbed(message.guild.id)
                        .setDescription(`✅ Successfully **Updated** Guild's Prefix to: \`${args[0]}\``),
                ],
            });
        };
    }
