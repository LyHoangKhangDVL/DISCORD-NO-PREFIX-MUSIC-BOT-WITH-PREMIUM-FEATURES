        ...
        let collector = await msg.createMessageComponentCollector({
          filter: (b) => {
            if (b.user.id === message.author.id) return true;
              ...
              return b.reply({
                content: `❌ You are not the help command requester`,
                ephemeral: true,
              });
          },
          time: 100000 * 7,
                ...
                return interaction
                  .update({
                    embeds: [
                      this.client.utils
                        .premiumEmbed(message.guildId)
                        .setTitle(`ℹ️ Informative Commands`)
                        .addFields([
                          {
                            name: `ℹ️ Information [${
                              this.client.commands.messages.filter(
