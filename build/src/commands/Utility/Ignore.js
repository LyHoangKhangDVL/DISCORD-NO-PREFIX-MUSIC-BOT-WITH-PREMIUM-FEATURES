                ...
                return message.reply({
                    embeds: [
                        this.client.utils
                            ...
                            .setDescription(`❌ You don't have **Manage Guild** permissions to use this command`)
                    ],
                });
            if (!args[0])
                return message.reply({
            ...
            if (args[0].toLowerCase() === `add`) {
                ...
                if (!channel)
                    return message.reply({
                        embeds: [
                            this.client.utils
                                .premiumEmbed(message.guildId)
                                .setDescription(`❌ Please provide me a valid channel`),
                        ],
                    });
                if (this.client.utils.checkIgnore(message.guildId, channel.id))
                    return message.reply({
                        embeds: [
                            this.client.utils
                                .premiumEmbed(message.guildId)
                                .setDescription(`❌ This Channel ${channel} is Already in my Ignore List!`),
                        ],
                    });
                ...
                if (list.length >= 5 &&
                    ...
                    return message.reply({
                        embeds: [
                            this.client.utils
                                .premiumEmbed(message.guildId)
                                .setDescription(`❌ This guilds need to be a **[Premium Guild](${this.client.config.server})** in order to add more than **5 Channels in Ignore List**`)
                        ],
                    });
                ...
                return message.reply({
                    embeds: [
                        this.client.utils
                            .premiumEmbed(message.guildId)
                            .setDescription(`✅ Successfully **Added** ${channel} to the Ignore List! Now I will Ignoring all of my Commands There!`)
                    ],
                });
            }
            if (args[0].toLowerCase() === `remove`) {
                ...
                if (!this.client.utils.checkIgnore(message.guildId, channel.id))
                    return message.reply({
                        embeds: [
                            this.client.utils
                                .premiumEmbed(message.guildId)
                                .setDescription(`❌ This Channel ${channel} is not present in my Ignore List!`),
                        ],
                    });
                ...
                return message.reply({
                    embeds: [
                        this.client.utils
                            .premiumEmbed(message.guildId)
                            .setDescription(`✅ Successfully **Removed** ${channel} from my Ignore List!`)
                    ],
                });
            }
                    ...
                    if (check === true) {
                        ...
                        return message.reply({
                            embeds: [
                                this.client.utils
                                    .premiumEmbed(message.guildId)
                                    .setDescription(`❌ **Removed** Admins from my **Ignore Bypass**`),
                            ],
                        });
                    }
                    else {
                        ...
                        return message.reply({
                            embeds: [
                                this.client.utils
                                    .premiumEmbed(message.guildId)
                                    .setDescription(`✅ **Added** Admins to **Ignore Bypass**`),
                            ],
                        });
                    }
                }
                    ...
                    if (check === true) {
                        ...
                        return message.reply({
                            embeds: [
                                this.client.utils
                                    .premiumEmbed(message.guildId)
                                    .setDescription(`❌ **Removed** Mods from my **Ignore Bypass**`),
                            ],
                        });
                    }
                    else {
                        ...
                        return message.reply({
                            embeds: [
                                this.client.utils
                                    .premiumEmbed(message.guildId)
                                    .setDescription(`✅ **Added** Mods to my **Ignore Bypass**`),
                            ],
                        });
                    }
                }
            ...
            if (args[0].toLowerCase() === `reset`) {
                ...
                return message.reply({
                    embeds: [
                        this.client.utils
                            .premiumEmbed(message.guildId)
                            .setDescription(`✅ Successfully **Resetted** the Ignore Module!`),
                    ],
                });
            }
        };
