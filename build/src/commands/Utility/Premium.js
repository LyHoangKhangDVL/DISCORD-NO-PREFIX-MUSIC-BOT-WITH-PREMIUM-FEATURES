    ...
    constructor(client) {
        ...
        this.exec = async (message, args, prefix) => {
                ...
                if (check.USER === null)
                    return message.reply({
                        embeds: [
                            this.client.utils
                                .premiumEmbed(message.guildId)
                                .setDescription(`❌ You don't have any kind of **[Premium](${this.client.config.server})** to be activated!`)
                                .setAuthor({
                                name: `${this.client.user.username}`,
                                iconURL: this.client.user.displayAvatarURL(),
                            })
                ...
                if (cnt.COUNT === 0)
                    return message.reply({
                        embeds: [
                            this.client.utils
                                .errorEmbed()
                                .setDescription(`❌ You don't have any **[Premiums](${this.client.config.server})** left to be activated`)
                                .setTimestamp()
                    ...
                    return message.reply({
                        embeds: [
                            this.client.utils
                                ...
                                .setDescription(`❌ Your [Premium](${this.client.config.server}) has been **Expired**`),
                        ],
                    });
                }
                    ...
                    return message.reply({
                        embeds: [
                            this.client.utils
                                ...
                                .setDescription(`❌ This Server is already in my Premium`),
                        ],
                    });
                }
                    ...
                    return message.reply({
                        embeds: [
                            this.client.utils
                                ...
                                .setDescription(`❌ You premium Code seems not to be working! Please contact the support`),
                        ],
                    });
                    ...
                    return message.reply({
                        embeds: [
                            this.client.utils
                                ...
                                .setDescription(`✅ Successfully **Added** [Premium](${this.client.config.server}) to ${guild.name} by **${message.author.tag}**\nExpires On: <t:${premTime}> (<t:${premTime}:R>)\nExecutive Code: \`${code.CODE}\``),
                        ],
                    });
                }
            }
                ...
                if (!user)
                    return message.reply({
                        embeds: [
                            this.client.utils
                                .errorEmbed()
                                .setDescription(`❌ Please provide me a valid User!`),
                        ],
                    });
                    ...
                    return message.reply({
                        embeds: [
                            this.client.utils
                                .errorEmbed()
                                .setTitle(`❌ Premium Not Found 💎`)
                                .setDescription(`❌ User ${user.tag} don't have any kind of [Premium](${this.client.config.server}).Please visit our [Support Server](${this.client.config.server}) to avail your Premium today!`)
                                .setTimestamp()
                                .setAuthor({
                                name: `${this.client.user.username}`,
                                iconURL: this.client.user.displayAvatarURL(),
                    ...
                    return message.reply({
                        embeds: [
                            this.client.utils
                                .errorEmbed()
                                .setTitle(`❌ Premium Not Found 💎`)
                                .setDescription(`❌ You don't have any kind of [Premium](${this.client.config.server}).Please visit our [Support Server](${this.client.config.server}) to avail your Premium today!`)
                                .setTimestamp()
                                .setAuthor({
                                name: `${this.client.user.username}`,
                                iconURL: this.client.user.displayAvatarURL(),
                    ...
                    return message.reply({
                        embeds: [
                            this.client.utils
                                ...
                                .setDescription(`❌ This guild: \`${guild.name}\` is not in my **[Premium](${this.client.config.server})** Guilds!`)
                                .setTimestamp(),
                        ],
                    });
                }
                    ...
                    return message.reply({
                        embeds: [
                            this.client.utils
                                ...
                                .setDescription(`❌ You are not the activator for this guild's Premium`)
                                .setAuthor({
                                name: `${this.client.user.username}`,
                                iconURL: this.client.user.displayAvatarURL(),
                            })
                ...
                if (rem === true) {
                    ...
                    return message.reply({
                        embeds: [
                            this.client.utils
                                ...
                                .setDescription(`✅ Successfully **Revoked** [Premium](${this.client.config.server}) for the guild by **${message.author.tag}**`)
                                .setTimestamp(),
                        ],
                    });
                }
                    ...
                    return message.reply({
                        embeds: [
                            this.client.utils
                                .errorEmbed()
                                .setDescription(`❌ Please contact devs!`),
                        ],
                    });
            }
            if (args[0].toLowerCase() === 'activator') {
                ...
                if (!guild) {
                    return message.reply({
                        content: `❌ Please provide me a valid Guild Id!`
                    });
                }
                let prem = this.client.utils.getServerPremiumStatus(guild.id);
                if (!prem)
                    return message.reply({
                        content: `❌ That Guild is not a Premium Guild!`
                    });
                ...
                if (get.USER !== null) {
                    ...
                    return message.reply({
                        content: `❌ Couldn't Get the Activator!`
                    });
                }
            }
        };
