    ...
    constructor(client) {
        ...
        this.exec = async (message, args, prefix) => {
            ...
            if (!user)
                return message.reply({
                    embeds: [
                        new this.client.utils.errorEmbed().setDescription(`❌ Please provide me a valid User`),
                    ],
                });
            if (this.client.utils.checkUserPrem(user.id) === false)
                return message.reply({
                    embeds: [
                        this.client.utils
                            .errorEmbed()
                            .setDescription(`❌ This User ${user} is not a Premium User`),
                    ],
                });
            let count = 0;
            let tier = "unknown";
                ...
                return message.reply({
                    embeds: [
                        this.client.utils
                            ...
                            .setDescription(`❌ Please provide me a valid time period!`),
                    ],
                });
                ...
                return message.reply({
                    embeds: [
                        this.client.utils
                            ...
                            .setDescription(`✅ Successfully **Updated** Premium to ${user} for ${count} Servers\nwhich will expire on: <t:${time}> (<t:${time}:R>)\nExecutive Code: \`${code}\``),
                    ],
                });
            else
                return message.reply({
                    content: `❌ Failed! Please contact my dev!`,
                });
        };
    }
}
