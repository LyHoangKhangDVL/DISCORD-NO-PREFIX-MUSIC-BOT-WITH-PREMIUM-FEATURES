        ...
        return message.reply({
          embeds: [
            new EmbedBuilder()
              ...
              .setDescription(
                `### 💎 \`${prefix}addPremium <user> <time> <count>\` 💎`,
              ),
          ],
        });
      let user;
        ...
        return message.reply({
          embeds: [
            new EmbedBuilder()
              .setColor(this.client.config.color)
              .setDescription(
                `# ❌ Please provide me a valid User`,
              ),
          ],
        });
      let count = 0;
        ...
        return message.reply({
          embeds: [
            new EmbedBuilder()
              ...
              .setDescription(
                `❌ Please provide me a valid time period!`,
              ),
          ],
        });
        ...
        return message.reply({
          embeds: [
            this.client.utils
              .errorEmbed()
              .setDescription(
                `** ❌ This User is already a Premium User!\n### Try updating premium by \`${prefix}updatePremium\` Command 💎**`,
              ),
          ],
        });
        ...
        return message.reply({
          embeds: [
            new EmbedBuilder()
              ...
              .setDescription(
                `✅ Successfully **Added** Premium to ${user} for ${count} Servers\nwhich will expire on: <t:${time}> (<t:${time}:R>)\nExecutive Code: \`${code}\``,
              ),
          ],
        });
      else
