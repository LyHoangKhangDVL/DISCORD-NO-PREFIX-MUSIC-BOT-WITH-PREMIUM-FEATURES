        ...
        this.exec = async (message, args, prefix) => {
                    ...
                    if (this.client.utils.checkGlobalNp(user.id) === true)
                        return message.reply({
                            embeds: [
                                this.client.utils
                                    .errorEmbed()
                                    .setDescription(`❌ This User ${user} is already in my **All Server's No Prefix**`),
                            ],
                        });
                    else {
                        ...
                        return message.reply({
                            embeds: [
                                this.client.utils
                                    .successEmbed()
                                    .setDescription(`✅ Successfully **Added** ${user} to my **All Server's No Prefix**`),
                            ],
                        });
                    }
                }
                    ...
                    if (!guild)
                        return message.reply({
                            embeds: [
                                this.client.utils
                                    .errorEmbed()
                                    .setDescription(`❌ Please provide me a valid guild!`),
                            ],
                        });
                    let id = guild.id;
                    if (this.client.utils.checkGuildNp(id, user.id) === true) {
                        return message.reply({
                            embeds: [
                                this.client.utils
                                    .errorEmbed()
                                    .setDescription(`❌ This User ${user} is already in ${guild.name}'s **Server No Prefix**`),
                            ],
                        });
                    }
                    else {
                        ...
                        return message.reply({
                            embeds: [
                                this.client.utils
                                    .successEmbed()
                                    .setDescription(`✅ Successfully **Added** ${user} to ${guild.name}'s **Server No Prefix**`),
                            ],
                        });
                    }
                }
                ...
                if (args[2] && args[2].toLowerCase() === `all`) {
                    if (this.client.utils.checkGlobalNp(user.id) === false) {
                        return message.reply({
                            embeds: [
                                this.client.utils
                                    .errorEmbed()
                                    .setDescription(`❌ This User ${user} is not present in my **All Server's No Prefix**`),
                            ],
                        });
                    }
                    else {
                        ...
                        return message.reply({
                            embeds: [
                                this.client.utils
                                    .successEmbed()
                                    .setDescription(`✅ Successfully **Removed** ${user} from my **All Server's No Prefix**`),
                            ],
                        });
                    }
                }
                    ...
                    if (this.client.utils.checkGuildNp(guild.id, user.id) === false) {
                        return message.reply({
                            embeds: [
                                this.client.utils
                                    .errorEmbed()
                                    .setDescription(`❌ This user ${user} is not included in ${guild.name}'s **Server No Prefix**`),
                            ],
                        });
                    }
                    ...
                    return message.reply({
                        embeds: [
                            this.client.utils
                                .successEmbed()
                                .setDescription(`✅ Successfully **Removed** ${user.tag} from **${guild.name}'s Server Prefix**`),
                        ],
                    });
                }
            }
            ...
            if (args[0].toLowerCase() === 'reset') {
                if (!this.client.config.owners.includes(message.author.id))
                    ...
                    return message.reply({
                        content: `✅ Successfully **Resetted** The No-Prefix for the Bot!`
                    });
                }
            }
        };
