                ...
                if (checkTrusted(user.id) === true)
                    return message.reply({
                        embeds: [
                            this.client.utils
                                .errorEmbed()
                                .setDescription(`❌ This User is already present in Trusted's List`),
                        ],
                    });
                else {
                    addTrusted(user.id);
                    return message.reply({
                        embeds: [
                            this.client.utils
                                .successEmbed()
                                .setDescription(`✅ Successfully **Added** ${user.tag} to my **Trusted's List**`),
                        ],
                    });
                }
            }
                ...
                if (checkTrusted(user.id) === false)
                    return message.reply({
                        embeds: [
                            this.client.utils
                                .errorEmbed()
                                .setDescription(`❌ This User is not present in Trusted's List`),
                        ],
                    });
                else {
                    ...
                    return message.reply({
                        embeds: [
                            this.client.utils
                                .successEmbed()
                                .setDescription(`✅ Successfully **Removed** ${user.tag} from my Trusted's List`),
                        ],
                    });
                }
            }
