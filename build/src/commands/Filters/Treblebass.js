...
export default class Treblebass extends OrasCommand {
    constructor(client) {
        super(client);
            ...
            return message.reply({
                embeds: [
                    this.client.utils
                        ...
                        .setDescription(`✅ Successfully **Applied Treblebass** filter to the Player`),
                ],
            });
        };
    }
}
//# sourceMappingURL=Treblebass.js.map