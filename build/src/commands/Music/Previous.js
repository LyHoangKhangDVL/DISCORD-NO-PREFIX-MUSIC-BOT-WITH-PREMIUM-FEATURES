            ...
            if (dispatcher.previous === null)
                return message.reply({
                    embeds: [
                        this.client.utils
                            ...
                            .setDescription(`❌ There is no **[Previous Song](${this.client.config.voteUrl})** in the queue!`),
                    ],
                });
            else {
                ...
                return message.reply({
                    embeds: [
                        this.client.utils
                            .premiumEmbed(message.guild.id)
                            .setDescription(`✅ Successfully **Started** playing [Previous Track](${this.client.config.voteUrl})`),
                    ],
                });
            }
        };
