                ...
                return message.reply({
                    embeds: [
                        this.client.utils
                            ...
                            .setDescription(`✅ Successfully **Updated** Loop mode of the player to **Off**`)
                    ],
                });
            }
            if (args[0].toLowerCase() === `track` ||
                ...
                return message.reply({
                    embeds: [
                        this.client.utils
                            .premiumEmbed(message.guildId)
                            .setDescription(`✅ Successfully **Updated** Loop mode of the player to **Track**`)
                    ],
                });
            }
            if (args[0].toLowerCase() === `all` ||
                ...
                return message.reply({
                    embeds: [
                        this.client.utils
                            .premiumEmbed(message.guildId)
                            .setDescription(`✅ Successfully **Updated** Loop mode of the player to **Queue**`)
                    ],
                });
            }
            else {
